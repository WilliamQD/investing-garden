...
if (!process.env.POSTGRES_URL && process.env.IG_POSTGRES_URL) {
  process.env.POSTGRES_URL = process.env.IG_POSTGRES_URL;
}
...
const migrations = [
  ...
  },
  {
    ...
    up: [
      ...
      `CREATE INDEX IF NOT EXISTS portfolio_trades_date_idx
        ON portfolio_trades (trade_date DESC)`,
      `CREATE INDEX IF NOT EXISTS portfolio_trades_ticker_idx
        ON portfolio_trades (ticker)`,
    ],
    down: [
      'DROP INDEX IF EXISTS portfolio_trades_ticker_idx',
      'DROP INDEX IF EXISTS portfolio_trades_date_idx',
      'DROP TABLE IF EXISTS portfolio_trades',
    ],
  },
  {
    id: 4,
    name: 'add_assistant_actions',
    up: [
      ...
      `CREATE INDEX IF NOT EXISTS assistant_actions_status_idx
        ON assistant_actions (status)`,
    ],
    down: [
      'DROP INDEX IF EXISTS assistant_actions_status_idx',
      'DROP INDEX IF EXISTS assistant_actions_created_at_idx',
