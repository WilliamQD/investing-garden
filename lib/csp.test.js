...
test('CSP headers are configured correctly', async () => {
  // Dynamically import the ESM config file (use file:// URL for Windows compatibility)
  ...
  assert.ok(
    policy.includes("frame-ancestors 'self' https://vercel.com https://*.vercel.com"),
    'Missing Vercel-compatible frame-ancestors directive'
  );
